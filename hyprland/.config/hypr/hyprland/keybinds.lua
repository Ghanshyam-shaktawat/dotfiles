...
hl.bind("SUPER + A", hl.dsp.global("quickshell:overlayToggle"), { description = "Shell: Toggle widget overlay" })
hl.bind(
	"CTRL + ALT + Delete",
...
hl.bind("ALT + TAB", hl.dsp.window.cycle_next({ "window" }), { description = "Cycle to next window" })
...
--##! Session
hl.bind("SUPER + CTRL + L", hl.dsp.exec_cmd("loginctl lock-session"), { description = "Session: Lock" })
-- hl.bind(
-- 	"SUPER + SHIFT + L",
...
hl.bind("SUPER + W", hl.dsp.exec_cmd("flatpak run app.zen_browser.zen -p"), { description = "App: Browser" })
hl.bind("SUPER + C", hl.dsp.exec_cmd(codeEditor), { description = "App: Code editor" })
hl.bind("SUPER + SHIFT + W", hl.dsp.exec_cmd(officeSoftware), { description = "App: Office software" })
...
hl.bind("SUPER + G", hl.dsp.exec_cmd("steam-native"))
