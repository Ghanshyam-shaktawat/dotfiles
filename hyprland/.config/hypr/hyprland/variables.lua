...
browser =
	"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'app.zen_browser.zen -p' 'google-chrome-stable' 'firefox' 'brave' 'chromium' 'microsoft-edge-stable' 'opera' 'librewolf'"
codeEditor =
