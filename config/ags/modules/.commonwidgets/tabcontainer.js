...
export const TabContainer = ({
  ...
  const tabs = Box({
    ...
    setup: (self) =>
      self.hook(shownIndex, (self) => {
        self.children[previousShownIndex].toggleClassName(
          "tab-btn-active",
          false,
        );
  ...
  const tabSection = Box({
    ...
    children: [
      EventBox({
        ...
        child: Box({
          vertical: true,
          children: [tabs, tabIndicatorLine],
        }),
      }),
    ],
  });
  ...
  const tabs = Box({
    ...
    setup: (self) =>
      self.hook(shownIndex, (self) => {
        ...
        self.children[shownIndex.value].toggleClassName(
          "tab-icon-active",
          true,
        );
        previousShownIndex = shownIndex.value;
