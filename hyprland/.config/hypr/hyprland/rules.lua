...
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Settings.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Save Scene.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Select.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Open.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Change Type.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Instantiate Child.*" },
	float = true,
	center = true,
	size = "1000 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Pick a node.*" },
	float = true,
	center = true,
	size = "300 600",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Node Script.*" },
	float = true,
	center = true,
	size = "600 300",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Signal.*" },
	float = true,
	center = true,
	size = "600 300",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Connections.*" },
	float = true,
	center = true,
	size = "600 300",
})
...
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*Auto.*" },
	float = true,
	center = true,
	size = "300 200",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*New Animation.*" },
	float = true,
	center = true,
	size = "300 200",
})
hl.window_rule({
	match = { class = "^(org.godotengine.Editor)", title = ".*DEBUG.*" },
	float = true,
	center = true,
	size = "1280 720",
})
...
--
-- # Steam rules
-- # windowrulev = match:class:^(steam)$, match:title:^(.*)(Friends List)$
-- # windowrulev = katch:class:^(steam)$, match:title:^(.*)(Chats)$
