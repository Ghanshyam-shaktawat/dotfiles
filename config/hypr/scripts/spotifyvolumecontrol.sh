...
increase_volume() {
	...
	notify-send -a Spotify -r 2 -t 1500 -i /usr/share/icons/Tela-circle-black/scalable/apps/com.spotify.Client.svg "Volume increased" "$VOLUME_PERCENT%"
}
...
decrease_volume() {
	...
	VOLUME=$(playerctl volume --player $PLAYER)
	VOLUME_PERCENT=$(awk "BEGIN {print int($VOLUME * 100)}")
	notify-send -a Spotify -r 2 -t 1500 -i /usr/share/icons/Tela-circle-black/scalable/apps/com.spotify.Client.svg "Volume decreased" "$VOLUME_PERCENT%"
}
